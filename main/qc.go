...
func contains(ss []string, t string) bool {
    for _, s := range ss { if s == t { return true } }
    return false
}
...
func main(){
    ...
    switch *format {
        case "concord": delimiters = qc.Concordance
        case "pipe": delimiters = qc.Piped
        case "hat" : delimiters = qc.PipeCarat
        case "tab" : delimiters = qc.Tabbed
        case "csv" : delimiters = qc.CSV
        default : delimiters = qc.Piped
    }
